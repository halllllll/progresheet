import { type CSSProperties, useEffect, forwardRef } from 'react';
...
const LabelColor = forwardRef<HTMLButtonElement, LabelColorProps>(
  (props, ref) => {
    const { idx, popover, cover, curColor } = props;
    ...
    return (
      <>
        <Button ref={ref} onClick={onOpen} background={color.hex} />
        {isOpen && (
          <Box style={popover}>
